...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--sequences", default="data/processed/beauty/item2vec_sequences.json")
    parser.add_argument("--output", default="data/processed/beauty/item_embeddings.pt")
